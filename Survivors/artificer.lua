...
local specialFireLeft = ParticleType.new("flamethrowerLeft")
specialFireLeft:sprite(sprFirey, true, true, false)
specialFireLeft:alpha(1)
specialFireLeft:scale(1, 1)
specialFireLeft:size(0.8, 1.2, 0.01, 0.02)
specialFireLeft:angle(0, 360, 0.01, 0.02, false)
specialFireLeft:life(45, 60)
specialFireLeft:direction(0, 0, 0, 0)
specialFireLeft:speed(2, 2, 0, 0)
local specialFireRight = ParticleType.new("flamethrowerRight")
specialFireRight:sprite(sprFirey, true, true, false)
specialFireRight:alpha(1)
specialFireRight:scale(1, 1)
specialFireRight:size(0.8, 1.2, 0.01, 0.02)
specialFireRight:angle(0, 360, 0.01, 0.02, false)
specialFireRight:life(45, 60)
specialFireRight:direction(180, 180, 0, 0)
specialFireRight:speed(2, 2, 0, 0)
